...
public final class RealtimePaths {
     ...
     */
    public static String eventJoin() { return "phx_join"; }

    /**
     * @return The event name for leaving a topic ("phx_leave").
     */
    public static String eventLeave() { return "phx_leave"; }

    /**
     * @return The event name for a reply from the server ("phx_reply").
     */
    public static String eventReply() { return "phx_reply"; }

    /**
     * @return The event name for the heartbeat keep-alive ("heartbeat").
     */
    public static String eventHeartbeat() { return "heartbeat"; }

    /**
     * @return The topic name for the core Phoenix channel ("phoenix").
     */
    public static String topicPhoenix() { return "phoenix"; }
     ...
     */
    public static String eventBroadcast() { return "broadcast"; }

    /**
     * @return The event name for presence state/diffs ("presence").
     */
    public static String eventPresence() { return "presence"; }

    /**
     * @return The event name for database changes ("postgres_changes").
     */
    public static String eventPostgresChanges() { return "postgres_changes"; }

    /**
     * @return The event name for system messages ("system").
     */
    public static String eventSystem() { return "system"; }
}